  ...
  return (
    <>
      <div className='home w-screen h-[80vh] justify-around flex bg-[#080808] p-[2rem]'>
        <div className='transparent flex flex-col justify-center items-center w-[40%]'>
        ...
        <div className='flex justify-center items-center flex-col p-3 w-[35%]'>
      ...
      <div className="banner w-screen h-[50vh] bg-[#080808] text-white flex justify-between p-[5rem] items-center">
        <div className='flex justify-center items-center flex-col w-[40%]'>
          <div className='text-2xl'> Accurate Market Prediction</div>
          <div className='text-2xl'>Avg income increas</div>
        </div>
        <div className='w-[30%]'>
      ...
      <div className='mt-[40vh]'><HowItWorks /></div>
    </>
  )
}
